...
public class Flake64LTest {
    ...
    public void shouldIsolateProcessesProperlyByWorkerIds() throws InterruptedException {
        ...
        Flake64Worker<Long> worker1 = new Flake64Worker<>(new Flake64L(timeProvider, new StaticWorkerIdProvider("A"), new LongEncoder()));
        Flake64Worker<Long> worker2 = new Flake64Worker<>(new Flake64L(timeProvider, new StaticWorkerIdProvider("B"), new LongEncoder()));

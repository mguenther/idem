...
public class Flake128STest {
    ...
    public void shouldIsolateProcessesProperlyByWorkerIds() throws InterruptedException {
        ...
        IdGeneratorWorker<String> worker1 = new IdGeneratorWorker<>(new Flake128S(timeProvider, new StaticWorkerIdProvider("A"), new Base62Encoder()));
        IdGeneratorWorker<String> worker2 = new IdGeneratorWorker<>(new Flake128S(timeProvider, new StaticWorkerIdProvider("B"), new Base62Encoder()));
